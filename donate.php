        ...
        <div class="row">
          <div class="col-md-9">
            <header class="single-post-header clearfix">
              <h2 class="post-title">Fresh Fire Mission House Project</h2>
            </header>
            <article class="post-content cause-item">
                <span class="post-meta meta-data">
                  <span><i class="fa fa-calendar"></i> 8th Sept, 2024</span>
                  <span><i class="fa fa-archive"></i> <a href="#">Domboshava</a>, <a href="#">Mungate</a></span>
                </span>
                <div class="spacer-20"></div>
                <div class="row">
                	<div class="col-md-7">
              			<img src="images/missionhouse.jpg" class="img-responsive">
                    </div>
                	<div class="col-md-5">
                        <ul class="list-group">
                          <li class="list-group-item">
                      	  ...
                      	  <li class="list-group-item"> <span class="badge">$100,000</span> Amount Needed </li>
                      	  <li class="list-group-item"> <span class="badge">$16,000</span> Collected yet </li>
                      	 <li class="list-group-item"> <span class="badge">365</span> Days left to achieve target</li>
                        </ul>
                  		<a href="indexlogin.php" class="btn btn-primary btn-lg btn-block donate-paypal" data-toggle="modal" data-target="#PaymentModal">Donate Now</a>
                    </div>
                </div>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    <p class="small short">If you would prefer to call in your donation, call on +263 771 434 383</p>
                  </div>
                </div>
              </div>
            </div>
