<?php include"header.php"; ?>
  ...
  <?php
               $id=$_GET['id'];
	$result = $db->prepare("SELECT * FROM donation where id= :post_id");
  ...
  <div class="page-header">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-2 col-sm-2 col-xs-4"> <a href="donation.php" class="pull-right btn btn-primary">All Donation</a> </div>
      </div>
    </div>
  </div>
  <!-- End Page Header --> 
          ...
          <div class="col-md-9">
            ...
            <article class="post-content">
              <div class="event-description"> 
                  ...
                  <div class="col-md-8">
                    <div class="panel panel-default">
                      ...
                      <div class="panel-body">
                        <ul class="info-table">
                          <li><i class="fa fa-calendar"></i> <strong><?php echo $row['payment_method']; ?></strong></li>
                ...
                <?php echo $row['detail']; ?>
				 <div class="post-meta"> 
				<h5>Share this Donation:</h5>                                    <!-- Go to www.addthis.com/dashboard to customize your tools -->
