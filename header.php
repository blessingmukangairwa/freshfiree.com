      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 col-sm-6 col-xs-8">
            ...
            <h1 class="logo"> <a href="index.php"><img src="images/logooo.png" alt="Logo" width="50" height="50"></a> </h1>
          </div>
          ...
          <div  class="ssss"> 
              ...
              <span>Fresh Fire And Miracles International Church</span>
            ...
            <nav class="navigation">
              <ul class="sf-menu">
                <li><a href="index.php">Home</a>
                 ...
                 <li><a href="sermon-updatess.php">Sermons</a>
              ...
              -->
                ...
                <ul class="dropdown">
                    <li><a href="our-excos.php">Assemblies</a></li>
                  </ul>
