  ...
  <div class="main" role="main">
        ...
        <div class="row">
		 ...
		 <?php                     
                            if(!isset($_GET["page"])){
                                ...
                                $tbl_name="sermo";		//your table name
	...
	/* Get data. */
				...
				//$news->execute();
	                          ...
	                          $news = ORM::for_table("sermo")
                                          ->limit($limit)
                                          ->offset($start)
                                          ->order_by_desc('sermo.id')
                                           ->find_array();
	...
	$lpm1 = $lastpage - 1;						//last page minus 1
	 ?>
            ...
            <article class="post">
              <div class="row">
                <div class="col-md-4 col-sm-4"> <a href="sermo_post.php?id=<?php echo $row['id'];?>"><img src="uploads/<?php echo $row['file'];?>" alt="" class="img-thumbnail img-responsive"></a> </div>
                <div class="col-md-8 col-sm-8">
                  <h3><a href="sermo_post.php?id=<?php echo $row['id'];?>"><?php echo $row['sermon_title']; ?></a></h3>
				  ...
				  <p><a href="sermo_post.php?id=<?php echo $row['id'];?>" class="btn btn-primary">Continue reading <i class="fa fa-long-arrow-right"></i></a></p>
                </div>
              </div>
            </article>
			<?php endforeach;?>	 
