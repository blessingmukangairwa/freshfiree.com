...
<!-- End Site Header --> 
  ...
  <div class="hero-slider flexslider clearfix" data-autoplay="yes" data-pagination="yes" data-arrows="yes" data-style="fade" data-pause="yes">
    <ul class="slides">
      <li class=" parallax" style="background-image:url(images/gggggggg.jpg);" ></li>
      <li class="parallax" style="background-image:url(images/aapoo.jpg);" width=500, height=500></li>
    </ul>
          ...
          <div class="col-md-8 col-sm-6"> 
            ...
            <div class="listing events-listing">
              <header class="listing-header">
                <h3 class=" titles">Welcome to Fresh Fire And Miracles International Church</h3>
              </header>
			  <?php
              ...
              <section class="listing-cont">
                <ul>
                  <li class="item sermon featured-sermon"> <span class="date"></span>
                    <h4><a href="https://www.facebook.com/freshfirezim">Like Us on Facebook</a></h4>
					<?php
                            //include('../connect.php');
...
<iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2F<?php echo $row['facebook'];?>%2F&tabs=timeline&width=20025&height=215&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=true&appId=403202216515066" 
        width="100%" height="214" style="border:none;overflow:hidden" scrolling="no" target="_blank" frameborder="0" 
