								...
								<div class="panel panel-default">
									...
									<div class="panel-body panel-body-com-m">
										...
										<form class="com-mail" action="save-news.php" method="post" enctype="multipart/form-data">
												...
												<TEXTAREA WRAP=VIRTUAL rows=6 cols=8  id="body" name="news_detail" class="form-control1 control2"></TEXTAREA>
												<TEXTAREA WRAP=VIRTUAL NAME="news_details"  id="body" COLS=20 ROWS=20 class="form-control1 control2"> </TEXTAREA>
												 <script>
