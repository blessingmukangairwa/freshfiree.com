 ...
 <body class="sticky-header left-side-collapsed"  onload="initMap()">
    ...
    <!-- left side start-->
		<div class="left-side sticky-left-side">
			...
			<div class="logo">
				<h1><a href="index.php">FFMIC <span>Admin</span></a></h1>
			</div>
					...
					<ul class="nav nav-pills nav-stacked custom-nav">
						...
						<li class="menu-list">
							<a href="#"><i class="lnr lnr-users"></i>
								<span>Manage Assemblies</span></a>
								<ul class="sub-menu-list">
									<li><a href="add-exco.php">Add Assemblies</a> </li>
									<li><a href="all-excos.php">All Assemblies</a></li>
								</ul>
						</li>
						...
						<li class="menu-list"><a href="#"><i class="lnr lnr-calendar-full"></i> <span>Manage Sermons</span></a>
							<ul class="sub-menu-list">
								<li><a href="compose-sermon.php">New Sermon</a> </li>
								<li><a href="all-sermons.php">All Sermons</a></li>
							</ul>
						</li>



						<li class="menu-list"><a href="#"><i class="lnr lnr-calendar-full"></i> <span>Manage Donation</span></a>
							<ul class="sub-menu-list">
								<li><a href="add-donation.php">New Donation </a> </li>
								<li><a href="all-donation.php">All Donation</a></li>
							</ul>
						</li>
						...
						<ul>
							<li class="dropdown profile_details_drop">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
									...
									<span style="background:url(images/3.jpg) no-repeat center"> </span> 
										 ...
										 <div class="user-name">
											...
											<p>
												...
												<?php 
												$namee=$_SESSION['SESS_FIRST_NAME'];
