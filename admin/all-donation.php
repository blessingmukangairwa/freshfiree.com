<?php include"header.php"; ?>
						  ...
						  <tbody>
						   <?php                     //include('../connect.php');
                            if(!isset($_GET["page"])){
                                ...
                                $tbl_name="donation";		//your table name
	...
	*/
	...
	/* Get data. */
				...
				$result = $db->prepare("SELECT * FROM donation  ORDER BY id DESC LIMIT $start, $limit");
				$result->execute();
	 ...
	 ?>
               ...
               ?> 
							...
							<tr>
							  ...
							  <td>
							    <a href="../donation-detail.php?id=<?=$row['id'] ?>" target="_blank" class="fa fa-eye-slash btn btn-xs btn-primary">View</a>
                                <a href="deletedonation.php?id=<?=$row['id'] ?>" class="fa fa-eraser btn btn-xs btn-success warning_4 delbtn" >Delete</a>
