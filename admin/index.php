<?php include "header.php"; ?> 
  ...
  // include('../connect.php');
  $result = $db->prepare("SELECT count(*) as total FROM donation");
  $result->execute();
  for($i=0; $row = $result->fetch(); $i++){
  ?>
					<h5><?php echo $row['total']; ?> </h5>
					<div class="grow grow1">
					  <p>Total Donation Programmes</p>
					</div><?php } ?>
				  </div>
			  </div>
		  </div>
...
$result = $db->prepare("SELECT count(*) as total FROM quote");
$result->execute();
for($i=0; $row = $result->fetch(); $i++){
?>
				  <h5><?php echo $row['total']; ?> </h5>
			...
			<div class="col-md-4 span_8">
				<div class="activity_box">
					...
					<?php
							...
							<div class="col-xs-3 activity-img"><img src= <?php $_SESSION['SESS_PRO_PIC']; ?> class="img-responsive" alt=""/></div>
